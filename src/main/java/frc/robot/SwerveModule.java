...
public class SwerveModule {
  ...
  public SwerveModule(
    ...
    m_turningMotor = new FlywheelSim(DCMotor.getNEO(1), 150.0 / 7.0, 0.004);
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    m_driveMotor.setInputVoltage(driveOutput + driveFeedforward);
    m_turningMotor.setInputVoltage(turnOutput);
  }
}
